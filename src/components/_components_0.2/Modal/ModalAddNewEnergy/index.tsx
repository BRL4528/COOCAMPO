...
interface IModalProps {
  handleAddNewEnergy: (energy: Omit<IEnergy, ''>) => void;
}

export function ModalAddNewEnergy({ handleAddNewEnergy }: IModalProps) {
  ...
  const handleSubmit = useCallback(
    ...
    [handleAddNewEnergy, onClose, reasonCost_center, reasonUnityItem],
  );
  ...
  return (
    <>
      <Tooltip bg="gray.650" hasArrow label="Novo custo de energia">
        <Button
          as="a"
          size="sm"
          colorScheme="blue"
        ...
        >
          ...
          {isWideVersion && <Text>Adicionar novo custo</Text>}
        </Button>
      </Tooltip>
      <ModalComponent
        title="Adicionar custos de energia"
        isOpen={isOpen}
        onClose={onClose}
