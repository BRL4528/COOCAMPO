...
import { Container, CardeHeader, CardGraphic, CardCenter } from './styles';
...
const SelectedSector: React.FC = () => {
  ...
  return (
    <Container ref={componentRef}>
      ...
      <CardCenter>
        <CardGraphic>
          <h2>Demosnstrativo do resultado - Fevereiro 2021 e Acomulado 2021</h2>
        </CardGraphic>
        <fieldset>
          <CardGraphic>
            <TableGoalsGlobal />
